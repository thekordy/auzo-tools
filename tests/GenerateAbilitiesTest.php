...
class GenerateAbilitiesTest extends AuzoToolsTestCase
{
    ...
    public function test_automatic_generate_crud_abilities_for_model()
    {
    ...
    public function test_automatic_generate_crud_abilities_for_model_fields()
    {
    ...
    public function test_automatic_generate_full_crud_abilities_for_model_and_fields()
    {
        $model = $this->userClass;
    ...
    public function test_automatic_generate_crud_abilities_for_model_with_custom_name()
    {
    ...
    public function test_automatic_generate_crud_abilities_for_model_fillable_fields_with_custom_name_delimiter()
    {
        $model = $this->userClass;
    ...
    public function test_automatic_generate_abilities_and_write_them_to_a_file()
    {
        $model = $this->userClass;
